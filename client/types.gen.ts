...
export type UpdateSettings = {
    ...
    double_board?: DoubleBoard | null;
    mandatory_straddle?: boolean | null;
};
...
export type PlayerActionResponse2 =
    PlayerActionResponses[keyof PlayerActionResponses];
...
export type VoteDealChoiceError =
    VoteDealChoiceErrors[keyof VoteDealChoiceErrors];
...
export type GenerateShareGameImageError =
    GenerateShareGameImageErrors[keyof GenerateShareGameImageErrors];
...
export type GetWithdrawalQuoteError =
    GetWithdrawalQuoteErrors[keyof GetWithdrawalQuoteErrors];
...
export type GetWithdrawalQuoteResponse =
    GetWithdrawalQuoteResponses[keyof GetWithdrawalQuoteResponses];
