...
const ActionButtons = ({
    ...
    useHotkeys('F', () => onDecisionClick(Action.FOLD), {
        enabled: keyboardShortcuts,
    });
    useHotkeys('K', () => onDecisionClick(Action.CHECK), {
        enabled: keyboardShortcuts,
    });
    useHotkeys('C', () => onDecisionClick(Action.CALL), {
        enabled: keyboardShortcuts,
    });
    useHotkeys('O', () => onDecisionClick(Action.CHECK_OR_FOLD), {
        enabled: keyboardShortcuts,
    });
    ...
    // Responsive sizes using viewport units similar to CommunityCards
    const buttonHeight = isPortrait ? '6vmax' : 'min(6.5vmin, 4.5vmax)';
    const buttonMaxHeight = isPortrait ? '2.75rem' : '2.75rem';
    ...
    return (
        ...
        >
            ...
            {leftAction && (
                <GridItem colSpan={1} w="100%" position="relative">
                    <Box
                        ...
                        bg={
                            variantColorMap[
                                leftAction.variant as keyof typeof variantColorMap
                            ] || 'brand.gray25'
                        }
            ...
            {!leftAction && <GridItem colSpan={1} />}{' '}
            {/* Empty space if no left action */}
            ...
            {middleAction && (
                <GridItem colSpan={1} w="100%" position="relative">
                    <Box
                        ...
                        bg={
                            variantColorMap[
                                middleAction.variant as keyof typeof variantColorMap
                            ] || 'brand.gray25'
                        }
                        borderRadius="0.75rem"
                        top="8px"
            ...
            {!middleAction && <GridItem colSpan={1} />}{' '}
            {/* Empty space if no middle action */}
            ...
            {rightAction && (
                <GridItem colSpan={1} w="100%" position="relative">
                    <Box
                        ...
                        bg={
                            variantColorMap[
                                rightAction.variant as keyof typeof variantColorMap
                            ] || 'brand.gray25'
                        }
                        borderRadius="0.75rem"
                        top="8px"
            ...
            {!rightAction && <GridItem colSpan={1} />}{' '}
            {/* Empty space if no right action */}
