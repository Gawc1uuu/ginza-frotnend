...
const Form = ({
    ...
    const getErrorMessage = () => {
        if (
            ...
            return `Buy-in must be between $${minBuyIn} and $${maxBuyIn}`;
        }
    ...
    return (
        ...
        >
            <Text color="purple.00" fontSize="14px" fontWeight="bold" textAlign="center" w="100%" mb="0.25rem">
                Buy In
            </Text>
            <HStack w="100%" justifyContent="space-between" spacing="6px" mb="0.25rem">
                <Text alignSelf="flex-start" color="purple.200" fontSize="sm" fontWeight="bold">
                    Available
                </Text>
                <HStack spacing="6px" alignItems="center">
                    <Image src="/GinzaCoin.webp" w="16px" h="16px" alt="Gold coin" />
                    <Text color="brand.white85" fontSize="sm" fontWeight="bold">
                        {formattedBalance}
                    </Text>
                </HStack>
            </HStack>
            ...
            >
                <InputGroup>
                    <InputLeftElement width="3.25rem" ml="-12px" top="50%" transform="translateY(-50%)">
                        <Image
                            src="/GinzaCoin.webp"
                            w="24px"
                            h="24px"
                    ...
                    />
                    <InputRightElement width="54px" top="50%" transform="translateY(-50%)">
                        <Button
                            h="30px"
                            size="sm"
                            onClick={(e) => {
