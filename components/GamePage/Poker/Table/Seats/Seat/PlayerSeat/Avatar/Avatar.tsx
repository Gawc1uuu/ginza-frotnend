    ...
    return (
        <Box minW={isPortrait ? '15vmax' : 'min(17.5vmin, 14vmax)'}>
            ...
            <Box
                ...
                padding={0}
                height="100%"
                border={isPortrait ? '0.1vmax solid' : '0.1vmin solid'}
                boxShadow={
                    isCurrentPlayer
                        ? '0 0 10px white'
                        : isWinner
                          ? '0 0 12px #4A9A6D, 0 0 10px #4A9A6D'
                          : 'none'
                }
                borderColor={
                    isWinner
                        ? 'green.300'
                        : isCurrentPlayer
                          ? 'rgba(188, 196, 200, 0.88)'
                          : !isFolded && !isAway
                            ? 'brand.gray15'
                            : 'brand.gray40'
                }
                borderRadius={isPortrait ? '1.85vmax' : '1.85vmin'}
                position="relative"
                bg={
                    isFolded || isAway
                        ? 'rgba(24, 25, 27)'
                        : // : 'linear-gradient(180deg,rgb(40, 43, 50), #12151B)'
                          'linear-gradient(180deg, rgba(47, 53, 58) 0%,rgba(21, 26, 30) 50%,rgba(17, 19, 20) 100%)'
                }
                zIndex={1000}
            >
                ...
                <Box
                    position="relative"
                    w={isPortrait ? '5vmax' : '5vmin'}
                    h={isPortrait ? '5vmax' : '5vmin'}
                    display="flex"
                    alignItems="center"
