...
export const AvatarProfile = ({
    ...
    return (
        <Box
            height={isPortrait ? '5.6vmax' : '5.6vmin'}
            width={isPortrait ? '5.6vmax' : '5.6vmin'}
            position="absolute"
            top="50%"
            left="45%"
        ...
        >
            ...
            <Box
                ...
                bg={
                    isFolded ||
                    (remainingTime !== null && isYourTurn && isCurrentPlayer)
                        ? 'brand.darkGray'
                        : 'transparent'
                }
            >
                <Image
                    ...
                    display="block"
                    opacity={
                        isFolded || (isYourTurn && isCurrentPlayer)
                            ? 0.25
                            : 1
                    }
                />
