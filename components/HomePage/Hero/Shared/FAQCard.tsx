...
const FAQQuestionCard = ({ gameConfig }: { gameConfig: FAQConfig }) => {
    ...
    return (
        <VStack
            spacing={0}
            w="96%"
            border="1px solid rgb(70, 55, 108)"
            borderRadius="1rem"
            overflow="hidden"
        ...
        >
            <Button
                ...
                fontSize="lg"
                fontWeight="800"
                background="linear-gradient(138.64deg, rgba(14, 14, 29, 0.9) 8.24%, rgba(38, 19, 60, 0.75) 98.03%), radial-gradient(60.52% 85.11% at 9.86% 66.12%, rgba(35, 17, 72, 0.75) 80%, rgba(22, 9, 49, 0) 10%)"
                _hover={{}}
                _active={{}}
            >
                {gameConfig.question}
...
export const FAQCard = () => {
    const gameConfigs: FAQConfig[] = [
        ...
        },
        {
            ...
            response:
                'Our team regularly sends game links in the Comrades Telegram channel, but we strongly encourage you to gather your own Cabal to organize and play games as well!',
        },
        {
            question: 'WHEN DO I GET SETTLED?',
            response:
                'Once you cash out of the game, your funds are settled at the end of the current hand, which you can play as you wait. Platform withdrawals are instant.',
        },
        {
            question: 'HOW TO CONTACT THE TEAM?',
            response:
                'Most communications are in our discord or Comrades Telegram channel!',
        },
    ];
    ...
    return (
        <Stack w="100%" spacing="8px">
            ...
            <Text
                ...
                color="brand.white90"
                alignContent="center"
                whiteSpace={useBreakpointValue({
                    base: 'nowrap',
                    lg: 'normal',
                })}
                overflow={useBreakpointValue({ base: 'hidden', lg: 'visible' })}
                textOverflow={useBreakpointValue({
                    base: 'ellipsis',
                    lg: 'unset',
                })}
