...
export const useGameData = () => {
    ...
    // const { data: gameDataQuery } = useWSQuery<{ gameData: any }>(
    ...
    // const gameData = gameDataQuery?.gameData as any;
    ...
    //     rabbitHuntSecondBoard: gameData?.rabbit_hunt_second_board ?? [],
    ...
    //     visibility: gameData?.visibility ?? 1,
    //     affiliatedBy: gameData?.internals?.affiliated_by ?? {},
    // };
};
