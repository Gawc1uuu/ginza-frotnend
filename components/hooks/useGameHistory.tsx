import { LedgerDto } from '../../../../packages/shared/shared.types';
...
export const processGameHistory = (
    userTransactions:
        | {
              userGameDebits: LedgerDto[];
              userGameCredits: LedgerDto[];
          }
        | undefined,
): GameDetails[] => {
    if (!userTransactions) {
